...
The Coalition runs as a **published Docker image** (`w2vy/coalition:latest`) deployed as a
...
**2. Register the Flux App:** Docker image `w2vy/coalition:latest`, container port **8088**,
