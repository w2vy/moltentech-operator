...
| `TRIAL_DAYS` | ✅ | 1–7; the Coalition refuses to start on 0 — the node is delivered inside the trial, before the first charge |
...
| `COALITION_SIGNING_KEY` | **`/onboard`, shown once** | the Coalition refuses to start |
