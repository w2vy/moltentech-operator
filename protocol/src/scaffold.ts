...
export function renderSecretsEnv(
  ...
  const lines = [
    ...
    "#",
    "# The old AGENT_KEY / COALITION_KEY bearers are no longer emitted here and no longer",
    "# used anywhere — Flux Hub dropped the columns that stored them. If your existing",
    "# env.json still has those two lines, delete them; the agent and Coalition each say so",
    "# once at startup.",
