...
export function renderSecretsEnv(
  ...
  const lines = [
    ...
    "# /onboard web flow after you sign, and shown ONCE — store them now or they are gone.",
    "# COALITION_SIGNING_KEY signs your Coalition's four reports to MT (Phase D). Leave it",
    "# blank to keep using the AGENT_KEY bearer; set it and redeploy to cut over, but only",
    "# AFTER MT has your Coalition pubkey pinned, or the reports 401.",
    "AGENT_KEY=",
    "COALITION_KEY=",
